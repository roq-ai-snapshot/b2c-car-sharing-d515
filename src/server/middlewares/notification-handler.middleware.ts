...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Vehicle Assignment.update': {
    roles: ['owner', 'admin', 'business-owner', 'fleet-manager', 'operations-staff', 'customer-service-representative'],
    key: 'vehicle_assignment',
    tenantPath: [],
    userPath: [],
  },
  'Complaint Resolution.update': {
    roles: ['owner', 'admin', 'business-owner', 'fleet-manager', 'operations-manager', 'operations-staff'],
