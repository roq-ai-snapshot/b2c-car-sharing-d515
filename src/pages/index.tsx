  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="B2C Car Sharing - Connecting Individual Customers to Nearby Cars, Seamlessly Managed by Our Dedicated Operations Staff"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Car Sharing - Connecting Individual Customers to Nearby Cars, Seamlessly Managed by Our Dedicated Operations Staff`}
            </Text>
            <Box
